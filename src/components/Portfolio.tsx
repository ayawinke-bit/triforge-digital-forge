...
const projects = [
  ...
  },
  {
    ...
    description: "Real-time threat monitoring and vulnerability assessment dashboard for enterprise clients.",
  },
  {
    title: "Brand Identity Suite",
    tags: ["Branding", "UI/UX", "Figma"],
    description: "Complete brand identity redesign including logo, style guide, and digital asset library.",
  },
  {
    title: "SaaS Application",
    tags: ["Full Stack", "TypeScript", "Cloud"],
    description: "Scalable SaaS platform with multi-tenant architecture and automated deployment pipelines.",
  },
];
